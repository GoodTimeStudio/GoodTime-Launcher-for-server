...
public class Options extends JDialog {
	...
	public Options() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) //±£´æÉèÖÃ
			{
				...
				if (textField_1.getText().isEmpty()) {
					Tip.main(null);
					Tip.dialog.setTitle("ÅäÖÃ´íÎó");
					Tip.textPane.setText("ÅäÖÃÃû³Æ²»ÄÜÎª¿Õ");
				} else {
					ConfigJson.java = textField.getText();//JAVAÂ·¾¶
					ConfigJson.profiles = textField_1.getText();//ÅäÖÃ
					Info.gameDir = textField_3.getText();//ÓÎÏ·Ä¿Â¼
					//Config.username = textField_1.getText();
					ConfigJson.memory = textField_2.getText();//×î´óÄÚ´æ
					ConfigJson.LVO = (String) comboBox_1.getSelectedItem();//Æô¶¯Æ÷×´Ì¬
		...
		textField_3.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 12));
		...
		AdvOpt.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 12));
		...
		chckbxNewCheckBox_2.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if (chckbxNewCheckBox_2.isSelected()) {
					Tip.main(null);
					Tip.textPane.setText("Å£±ÆºåºåµÄ¸ß¼¶¹¦ÄÜ£¡¿ªÆô¿ÉÄÜµ¼ÖÂÓÎÏ·±ÀÀ££¬\r\nÈ·¶¨Òª¿ªÆôÂð£¿");
					Tip.dialog.setTitle("Java¶îÍâ²ÎÊý");
				}
			}
		});
		...
		textField_4.setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 12));
		...
		comboBox_1.setEnabled(false);
		comboBox_1.addItem("Æô¶¯ºóÒþ²ØÆô¶¯Æ÷");
		comboBox_1.addItem("Æô¶¯ºó±£³ÖÆô¶¯Æ÷¿ªÆô");
		comboBox_1.addItem("Æô¶¯ºó¹Ø±ÕÆô¶¯Æ÷");
