...
public class CoreGui extends JFrame {
	 ...
	 */
	public CoreGui() {
		setTitle("GoodTime-Launcher Beta 0.1");
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				//-------------------
				try {
					ConfigJson.oldPro = comboBox.getSelectedItem().toString();
					Options.main(null);
					Options.textField_1.setText(comboBox.getSelectedItem().toString());
					ConfigJson.load();
	...
	/*/±³¾°--------------------------------------
		...
		btnNewButton_3.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent arg0) {
				Options.opt.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
				Options.opt.setVisible(true);
				Options.textField_1.setText("ÐÂµÄÅäÖÃ");
		...
		if (ConfigJson.username.isEmpty()) {} else {
			CoreGui.label.setText("×ð¾´µÄ "+ConfigJson.username);
		}	
	}
